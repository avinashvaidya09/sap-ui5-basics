		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP UI5 BASICS",
									"targetURL": "#comlearnui5sapui5basics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlearnui5sapui5basics-display": {
								"semanticObject": "comlearnui5sapui5basics",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.learn.ui5.sapui5basics",
									"url": sap.ui.require.toUrl("com/learn/ui5/sapui5basics")
								}
							}
						}
					}
